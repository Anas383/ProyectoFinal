...
<head>
    ...
    <!-- ESTE ENLACE ES PARA NORMALICE, UN SISTEMA QUE NORMALIZA LOS PADDINGS Y MARGINS EN TODOS LOS NAVEGADORES -->
...
<body >
    ...
    <div class="container row-md contenedor">
        ...
        <div class="row">
            <!-- ESTE ES EL DROPDOWN QUE UTILIZO PARA HACER EL FILTRO -->
            <div class="col-md-3">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <?php 
                            // ESTA CONSULTA BUSCA TODAS LAS CATEGORÍAS 
            ...
            <div class="col-md-6"></div>
             <!-- ESTE ES EL INPUT PARA BUSCAR  PRODUCTOS -->  
            <div class="col-md-3">
        ...
        <div class="row mb-5">
            ...
            <?php  
                // HACEMOS LA CONSULTA PARA BUSCAR TODOS LOS PRODUCTOS  
        ...
        <!-- ESTE ES EL MODAL PARA CUANDO EL PRODUCTO ESTA SIN STOCK-->
