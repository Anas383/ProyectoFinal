...
<?php include_once "Loader.php"?>
        ...
        <div class="contenedorPerfil">
            ...
            <div class="jumbotron text-center ">
                <div class="container">
                    ...
                    <hr class="my-4">
                    <!-- AQUI RECOGEMOS EL PRECIO POR UN GET OBTENIDO DESDE EL CARRITO -->
                    ...
                    <p>Para aclaraciones:<strong>animetek382@gmail.com</strong></p>
                </div>
            </div>
    ...
    <!--Scripts--> 
    <!-- SCRIPT NECESARIO PARA PAYPAL EN EL CUAL SE HA PUESTO EUR AL FINAL PARA QUE EL PRECIO SEA EN EUROS -->
    ...
    <script >
            ...
            createOrder: function(data, actions) {
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            // EN ESTE VALUE METEMOS EL PRECIO TOTAL
                            value: '<?php echo $precioTotal ?>' ,
                            // AQUI EN DESCRIPCION METEMOS LOS DETALLES 
            ...
            // FINALIZAMOS LA TRANSACCION Y NOS ENVIA MEDIANTE EL WINDOW LOCATION A VACIAR CARRITO PAYPAL
