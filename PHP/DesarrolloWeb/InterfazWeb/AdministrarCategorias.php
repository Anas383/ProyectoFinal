            ...
            <table class="table bg-light rounded ">
                ...
                <tbody  >
                    <tr >
                        ...
                        <td class="botonesTablasEdicion"><a href="ModificarUsuario.php" class="btn btn-primary "><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Modificar</a><a href="#" data-toggle="modal" data-target="#emergenteEliminarCategoria"  class="btn btn-danger ">Eliminar</a></td>
