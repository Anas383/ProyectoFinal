        ...
        <div class="row">
            <div class="table-responsive col-md-12">
                <table class="table bg-light rounded   text-center">
                    ...
                    <?php 
                        //ESTA ES LA CONSULTA QUE ME LISTA TODAS LAS CATEGORÍAS 
                    ...
                    <tbody>
                        ...
                        ?>
                        <?php
                        if(isset($_GET['error']) && $_GET['error'] == "categoriaNoEliminada"){ 
                            echo "<script>swal('AnimeTEK', 'No se ha podido eliminar la categoría, hay productos que dependen de ella, eliminalos primero.', 'error');</script>";
