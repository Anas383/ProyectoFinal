<?php
    ...
    //INICIAMOS SESION
    session_start();
    // RECIBIMOS Y GUARDAMOS EN UNA VARIABLE EL GET DEL idProducto
            ...
            <div class=" col-md-6 contenedorFormulario ">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page">Modificar Producto</li>
                    </ol>
                </nav>
                ...
                <form action="GuardarModificacionesProducto.php?idProducto=<?php echo $producto['idProducto'];?>" id="FormularioAñadirProductos" method="post" enctype="multipart/form-data">
                    <legend>Modificar producto:<br><?php echo $producto['NombreProducto'];?> </legend>  
                        ...
                        <div class="grupo_nombre col-md-12  ">
                            ...
                            <br>
                            <p class="mensajeError-oculto" id="mError-nombre">&nbsp;¡El producto debe contener un nombre!</p>
                        </div><br>
                        ...
                        <div class="grupo_categorias  col-md-12 ">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" name="categorias" id="categorias">
                                    <?php
                                        //SELECCIONAMOS EL idCategoria DEL PRODUCTO 
                                        $idCategoriaProducto=$producto['idCategoria'];
                                        //Y BUSCAMOS LA CATEGORIA DE ESTE PRODUCTO
                                        $categoriaProducto=buscarCategoriaPorID($conexion, $idCategoriaProducto);
                                        $categoriaP=mysqli_fetch_assoc($categoriaProducto);
            
                                    ?>
                                    <!-- AQUI MOSTRAMOS EL OPTION SELECTED CON EL NOMBRE DE LA CATEGORIA DEL PRODUCTO -->
                        ...
                        <div class="grupo_stock col-md-12  ">
                            ...
                            <input type="number" name="stock" min="0"  id="stock" class="form-control" value="<?php echo $producto['Stock'];?>" required>
