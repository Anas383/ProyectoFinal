...
<body >
    ...
    <div class="container-fluid">
        <div class="row ">
         ...
         <!-- ESTA ES LA TABLA QUE MUESTRA TODAS LOS PRODUCTOS EN LA BASE DE DATOS -->
        <div class="row">
            ...
            <div class="table-responsive col-md-12">
                <table class="table bg-light rounded">
                    ...
                    <?php
                        //ESTA ES LA CONSULTA QUE ME LISTA TODOS LOS PRODUCTOS
